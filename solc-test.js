...
contract Viewer is BaseRegistrar, ERC721 {
...
console.log(output.contracts['test.sol']['Viewer'].evm.bytecode.object);
console.log(output.contracts['test.sol']['Viewer']);